                  ...
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        Expanded(
                          child: Text(
                            'Cart :  \$ ${FFAppState().cartum.toString()}',
                        ...
                        return Column(
                          ...
                          children: List.generate(cart.length, (cartIndex) {
                            ...
                            return Row(
                              ...
                              children: [
                                Expanded(
                                  child: StreamBuilder<UserCardRecord>(
                                    stream:
                                        UserCardRecord.getDocument(cartItem),
                                    builder: (context, snapshot) {
                                      ...
                                      final cardUserCardRecord = snapshot.data!;
                                      return Card(
                                        clipBehavior:
                                                                ...
                                                                padding:
                                                                    EdgeInsetsDirectional
                                                                        .fromSTEB(
                                                                            ...
                                                                            0.0),
                                                                child: Text(
                                                                  '\$ ${cardUserCardRecord.price.toString()}',
