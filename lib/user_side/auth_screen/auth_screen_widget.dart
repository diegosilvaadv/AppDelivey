...
class _AuthScreenWidgetState extends State<AuthScreenWidget> {
  ...
  void initState() {
    ...
    _model.emailAddressController ??= TextEditingController(text: 'Seu E-mail');
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Scaffold(
        key: scaffoldKey,
        backgroundColor: Color(0xFFB31416),
        body: Padding(
            ...
            children: [
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    Image.asset(
                      'assets/images/Pizza-logo-design-template-Vector-PNG.png',
                      width: 200.0,
                      height: 200.0,
                      fit: BoxFit.fitWidth,
                    ),
